<script lang="ts">
 ...
 /*  function getAuthCookie_() {
    ...
    <div id="pointer-ring" style="border-color: rgb(82, 200, 233); padding: 25px; transform: translate(203px, 610px);"></div><div id="pointer-dot" style="border-color: rgb(113, 88, 190); transform: translate(228px, 635px);"></div><div id="">
      <Header />
      <Slide />
      <style>
...
<section class="hakkimizda-bolumu-anasayfa1">
  <div class="container">
      <div class="tablo--1-ve-2 masqueur à effet de révélation d'image de projet wow animated" style="visibility: visible;">
          <div class="row">
              <div class="col-md-8">
                  <h1 style="font-size: 3.5rem;text-transform: none;" class="h2-baslik-anasayfa-ozel h-yazi-margin-kucuk">Bienvenue sur la<br>
          ...
          <br>
                  ...
                  Bienvenue! Veuillez payer votre adhésion pour activer votre compte! <b><u><a href="paiement" style="color:#58151c">Cliquez ici</a></u></b>
              </div>
                  ...
                  <div class="col-md-4">
                              ...
                              <div class="text">Mise à jour du dossier <i class="fa fa-lock"></i> </div>
                          </div>
                                          </div>
                  <div class="col-md-4">
