...
<Entete libelle="Gestion des racine de sequence" parent="Parametres" descr="Liste des racine de sequence" />
<section class="content">
  <div class="row">
    <div class="col-12">
      <div class="box">
        <div class="box-header with-border flex justify-between items-center">
          <h4 class="box-title text-xl font-medium">Liste des racine de sequence</h4>
