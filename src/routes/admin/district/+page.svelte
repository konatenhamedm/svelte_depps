<script lang="ts">
  ...
  import type { District, Permission, User } from "../../../types";
  ...
  $: filteredData = main_data.filter((item) => {
    return (
      item.region.libelle.toLowerCase().includes(searchQuery.toLowerCase()) ||
...
<Entete
  libelle="Gestion des districts"
  parent="Parametres"
  descr="Liste des districts"
/>
    ...
    <div class="col-12">
      <div class="box">
        <div class="box-header with-border flex justify-between items-center">
          <h4 class="box-title text-xl font-medium">Liste des districts</h4>
        ...
        <div class="box-body">
          <div class="table-responsive">
            ...
            <Table class="border border-gray-300">
              ...
              >
                {#each ["libelle", "region", "Action"] as title}
                ...
                {:else}
                  {#each paginatedProducts as item}
                    <TableBodyRow class="text-base border border-gray-300">
                      ...
                      >
                      <TableBodyCell class="p-4 border border-gray-300"
                        >{item.region.libelle}</TableBodyCell
                      >
