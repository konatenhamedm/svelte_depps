...
{#each paginatedProducts as item}
  <TableBodyRow class="text-base border border-gray-300">
    ...
    <TableBodyCell class="p-2 w-8 border border-gray-300">
      <!-- Dropdown géré par <details> -->
      <details class="relative">
        <!-- Bouton d'ouverture sans le marqueur par défaut -->
        ...
        <!-- Contenu du menu dropdown affiché au-dessus, aligné à gauche et avec un z-index élevé -->
        <div class="absolute right-0 bottom-full mb-1 w-32 bg-black border border-gray-200 rounded-md shadow-lg z-50">
          <div class="py-1">
            <!-- Bouton Voir -->
            <button
