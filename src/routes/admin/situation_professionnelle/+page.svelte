...
<Entete libelle="Gestion des situations professionnelles" parent="Parametres" descr="Liste des situations professionnelles" />
<section class="content">
  <div class="row">
    <div class="col-12">
      <div class="box">
        <div class="box-header with-border flex justify-between items-center">
          <h4 class="box-title text-xl font-medium">Liste des situations professionnelles</h4>
          ...
          <div>
            ...
            >
              + Nouveau situations professionnelles
            </a>
          </div>
        </div>
        <!-- /.box-header -->
