<script lang="ts">
  ...
  import type { Commune, District, Permission, User } from "../../../types";
  ...
  $: filteredData = main_data.filter((item) => {
    return (
      item.ville.libelle.toLowerCase().includes(searchQuery.toLowerCase()) ||
...
<Entete
  libelle="Gestion des communes"
  parent="Parametres"
  descr="Liste des communes"
/>
    ...
    <div class="col-12">
      <div class="box">
        <div class="box-header with-border flex justify-between items-center">
          <h4 class="box-title text-xl font-medium">Liste des communes</h4>
        ...
        <div class="box-body">
          <div class="table-responsive">
            ...
            <Table class="border border-gray-300">
              ...
              >
                {#each ["libelle", "Ville", "Action"] as title}
                ...
                {:else}
                  {#each paginatedProducts as item}
                    <TableBodyRow class="text-base border border-gray-300">
                      ...
                      >
                      <TableBodyCell class="p-4 border border-gray-300"
                        >{item.ville.libelle}</TableBodyCell
                      >
