        ...
        <div class="box-body">
          <div class="table-responsive">
            ...
            <Table class="border border-gray-300">
              ...
              >
                {#each ["username", "Identité", "Type de compte", "Action"] as title}
                ...
                {:else}
                  {#each paginatedProducts as item}
                    <TableBodyRow class="text-base border border-gray-300">
                      ...
                      >
                      <TableBodyCell class="p-4 border border-gray-300"
                        >{item.typeUser == "PROFESSIONNEL" ? item.personne.nom + " " + item.personne.prenoms : item.personne.typePersonne == "PHYSIQUE" ? item.personne.nom + " " + item.personne.prenoms : item.personne.denomination}</TableBodyCell
                      >
                      <TableBodyCell class="p-4 border border-gray-300"
