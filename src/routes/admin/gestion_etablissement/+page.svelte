<script lang="ts">
  ...
  import type {EndUser, GetEtablissementData, professionnel} from '../../../types';
            ...
            <Table class="border border-gray-300">
              ...
              >
                {#if user.type == 'ADMINISTRATEUR'}
                  ...
                  {#each ['nom', 'prénoms','email',"Niveau d'Intervention", 'Téléphone/Autre email',  'Entité Juridique',  'imputation'] as title}
                    {#if title}
                      <TableHeadCell
                ...
                {:else}
                  ...
                  {#each ['nom', 'prénoms','email',"Niveau d'Intervention", 'Téléphone/Autre email',  'Entité Juridique',  'Imputation', 'Action'] as title}
                  {#if title}
                    <TableHeadCell
                      class="ps-4 font-normal border border-gray-300"
                    >
                ...
                {:else}
                  {#each paginatedProducts as item}
                    <TableBodyRow class="text-base border border-gray-300">
                      ...
                      >
                        <TableBodyCell class="p-4 border border-gray-300"
                        >{item.personne.niveauIntervention.libelle}</TableBodyCell
                      >
                      <TableBodyCell class="p-4 border border-gray-300"
