<script lang="ts">
    ...
    import type { Civilite, Pays } from "../../../types.js";
...
<Sub_header titre="Inscription en tant que professionnel de santé" subTitles={[{ title: "Inscription", link: "/new_site/professionnel" }]}></Sub_header>
