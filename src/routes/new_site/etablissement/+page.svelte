...
import type { Civilite,Genre,Pays,Specialite,Ville } from "../../../types.js";
...
function initPaiement() {
    ...
    formDatas.append("nom", formData.nomEntreprise);
    formDatas.append("prenoms", formData.natureEntreprise);
