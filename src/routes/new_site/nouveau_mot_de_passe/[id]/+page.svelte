<script>
  ...
  <Sub_header titre="Réinitialisez du compte" subTitles={[{ title: "Réinitialisez votre mot de passse", link: "/new_site/nouveau_mot_de_passe/"+`${$page.params.id}` }]}></Sub_header>
              ...
              <form action="#" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-12 text-center">
                    <button type="submit" class="btn btn-info w-p100 mt-15">VALIDER</button>
                  </div>
                </div>
              </form>
