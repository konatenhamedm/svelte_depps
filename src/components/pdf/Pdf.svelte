...
<script>
    ...
    function addHeader(doc, logoImage) {
        ...
        doc.text(`Date : ${new Date().toLocaleDateString()}`, 200, 20, null, null, 'right');
    }
...
<button on:click={exportToPDF} class="flex items-center px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors">
