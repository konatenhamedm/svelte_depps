	...
	<section class="sidebar position-relative"> 
	 ...
	 <div class="multinav">
		 <div class="multinav-scroll" style="height: 100%;">    
			...
			<li class="header fs-10 m-0 text-uppercase text-3xl" style="text-transform: uppercase; color:white ! important;font-weight: bold">Dashboard</li>
			...
			<li class="header fs-10 m-0 text-uppercase text-3xl" style="text-transform: uppercase; color:white ! important;font-weight: bold">Parametres</li>
			<li class="treeview">
				<a href="#">
			...
			<li class="header fs-10 m-0 text-uppercase text-3xl text-3xl" style="text-transform: uppercase; color:white ! important;font-weight: bold">Gestion dossiers</li>
			<li class="path1">
...
<li class="path1">
			...
			<li class="header fs-10 m-0 text-uppercase text-3xl" style="text-transform: uppercase; color:white ! important;font-weight: bold">Gestion des statistiques</li>
			<li class="path1">
