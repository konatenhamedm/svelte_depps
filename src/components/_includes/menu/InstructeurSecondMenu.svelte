  ...
  <div class="multinav">
    <div class="multinav-scroll" style="height: 100%;">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="path1">
          <a href="/admin/instructeur-dashboard">
            <svg
        ...
        <li
          class="header fs-10 m-0 text-uppercase text-3xl text-3xl"
          style="text-transform: uppercase; color:white ! important;font-weight: bold"
        >
          Gestion dossiers
        </li>
        <li class="path1">
          <a href="/admin/professionnel_instructeur_second">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
        ...
        <li class="path1">
          <a href="/admin/statistique/general">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
