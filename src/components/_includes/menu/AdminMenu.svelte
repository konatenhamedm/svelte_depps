...
<section class="sidebar position-relative" >
  <div class="multinav" >
    <div class="multinav-scroll" style="height: 100%;overflow-y: auto; overflow-x: hidden">
      <!-- sidebar menu-->
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="path1">
          ...
          <ul class="treeview-menu">
            ...
            <li>
              <a href="/admin/situation_professionnelle"
                ><i class="icon-Commit"
                  ><span class="path1"></span><span class="path2"></span></i
        ...
        >
          ...
          <li>
            ...
            <span>Types profession</span>
            <span class="pull-right-container"></span>
              </a>
            </li>
            <li>
              <a href="/admin/profession"
                ><svg
              fill="none"
              stroke="currentColor"
              stroke-width="2"
        ...
        <li class="path1">
         ...
         <li class="path1">
          <a href="/admin/niveau_intervention">
            <svg
              fill="none"
              stroke="currentColor"
              stroke-width="2"
       ...
       <li
        ...
        <li class="path1">
          <a href="/admin/utilisateur_externe">
            <svg
              fill="none"
              stroke="currentColor"
              stroke-width="2"
            ...
            <span>Utilisateurs externes</span>
            <span class="pull-right-container"> </span>
          </a>
        </li>
