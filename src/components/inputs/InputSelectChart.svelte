<script lang="ts">
  type Select = { id: string, libelle: string };
...
<div class="w-full mx-auto col-span-6 space-y-1 sm:col-span-3">
  ...
  >
    <option value="null" selected>Veuillez sélectionner {label}</option>
